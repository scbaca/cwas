...
(b) LDREF data from 1000 genomes (https://data.broadinstitute.org/alkesgroup/FUSION/LDREF.tar.bz2). This goes in the LDREF folder. 
(c) GWAS summary statistics files, with file names *.sumstats.gz
