...
#opt$bfile="tmp/1_10/peak2_526450_526850"  #the base name
#opt$tmp="tmp/1_10/peak2_526450_526850"
#opt$out="./WEIGHTS/ALL/ALL.peak2_526450_526850"
#opt$models="lasso,top1"
#opt$covar="../analysis/predict/covar.mat"
#opt$PATH_plink="plink2"
#opt$PATH_gcta="gcta64"
#opt$PATH_gemma="gemma"
...
#tmp	#---new
#	#added 8/2/20: reformat covar and add expected extra column:
...
# cwas workflow just uses output above
